...
const expiredCheck = (zel, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            nolan.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              nolan.groupLeave(_dir[position].id)
